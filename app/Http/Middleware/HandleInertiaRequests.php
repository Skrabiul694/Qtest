...
class HandleInertiaRequests extends Middleware
{
    ...
    public function share(Request $request)
    {
        ...
        return array_merge(parent::share($request), [
            'general' => config('qtest.version') == "1.3.0" ? $settings->toArray() : [],
            'canLogin' => \Route::has('login'),
            'canResetPassword' => \Route::has('password.request'),
            'isDemo' => config('qtest.demo_mode'),
            ...
            'rtl' => config('qtest.version') == "1.2.0" ? app(LocalizationSettings::class)->default_direction == 'rtl' : false,
            'locale' => function () {
            ...
            'appVersion' => config('qtest.version'),
        ]);
    }
}
