...
class CreateGeneralSettings extends SettingsMigration
{
    ...
    {
        $this->migrator->add('site.app_name', 'qtest');
        $this->migrator->add('site.tag_line', 'Everything You Need For Your Exam Preparation.');
        $this->migrator->add('site.seo_description', 'qtest Pro is an online test examination software and assessment tool that assists educational institutions,corporate companies to create and conduct web and mobile based exams.');
        ...
        $this->migrator->add('email.from_address', 'admin@qtest.com');
        $this->migrator->add('email.from_name', 'qtest');
    }
}
